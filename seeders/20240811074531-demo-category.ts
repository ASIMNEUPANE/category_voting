...
const categoriesData = [
  // Parent Categories
  { id: 1, name: 'Electronics', parentId: null, createdAt: now, updatedAt: now },
  { id: 2, name: 'Home Appliances', parentId: null, createdAt: now, updatedAt: now },
  ...
  { id: 10, name: 'Android Phones', parentId: 7, createdAt: now, updatedAt: now },
  { id: 11, name: 'iPhones', parentId: 7, createdAt: now, updatedAt: now },

  // Children of Home Appliances
  { id: 12, name: 'Kitchen Appliances', parentId: 2, createdAt: now, updatedAt: now },
  { id: 13, name: 'Cleaning Appliances', parentId: 2, createdAt: now, updatedAt: now },

  // Grandchildren of Home Appliances
  { id: 14, name: 'Microwaves', parentId: 12, createdAt: now, updatedAt: now },
  { id: 15, name: 'Refrigerators', parentId: 12, createdAt: now, updatedAt: now },
  { id: 16, name: 'Vacuum Cleaners', parentId: 13, createdAt: now, updatedAt: now },
  ...
  { id: 21, name: 'Science Fiction', parentId: 18, createdAt: now, updatedAt: now },
  ...
  // Children of Fashion
  { id: 24, name: 'Men\'s Clothing', parentId: 4, createdAt: now, updatedAt: now },
  { id: 25, name: 'Women\'s Clothing', parentId: 4, createdAt: now, updatedAt: now },
  ...
  // Children of Sports
  { id: 30, name: 'Outdoor Sports', parentId: 5, createdAt: now, updatedAt: now },
  { id: 31, name: 'Indoor Sports', parentId: 5, createdAt: now, updatedAt: now },
  ...
  { id: 34, name: 'Table Tennis', parentId: 31, createdAt: now, updatedAt: now },
